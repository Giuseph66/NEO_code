...
export class ChatSetupContribution extends Disposable implements IWorkbenchContribution {
	...
	private registerGrowthSession(chatEntitlementService: ChatEntitlementService): void {
		...
		const updateGrowthSession = () => {
			...
			// Show for users who don't have the Neo Agents extension installed yet.
	...
	private registerActions(context: ChatEntitlementContext, requests: ChatEntitlementRequests, controller: Lazy<ChatSetupController>): void {
		...
		class ChatSetupTriggerAction extends Action2 {
			...
			static CHAT_SETUP_ACTION_LABEL = localize2('triggerChatSetup', "Use Neo Agents for free...");
		...
		class UpgradePlanAction extends Action2 {
			constructor() {
				super({
					...
					title: localize2('managePlan', "Upgrade to Neo Agents Pro"),
					category: localize2('chat.category', 'Neo Agents'),
					f1: true,
		...
		class EnableOveragesAction extends Action2 {
			constructor() {
				super({
					...
					title: localize2('manageOverages', "Manage Neo Agents Overages"),
					category: localize2('chat.category', 'Neo Agents'),
					f1: true,
					precondition: ContextKeyExpr.and(
						ChatContextKeys.Setup.hidden.negate(),
