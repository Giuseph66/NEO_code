...
export class GrowthSessionController extends Disposable implements IChatSessionItemController {
	...
	get items(): readonly IChatSessionItem[] {
		...
		return [{
			...
			label: localize('growthSession.label', "Try Neo Agents"),
			description: localize('growthSession.description', "Neo Agents is available. Try it for free."),
