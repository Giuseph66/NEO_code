...
export const CHAT_CATEGORY = localize2('chat.category', 'Neo Agents');
		...
		constructor() {
			super({
				...
				keybinding: {
					...
					secondary: [KeyMod.CtrlCmd | KeyMod.Alt | KeyCode.KeyI],
					mac: {
						primary: KeyMod.CtrlCmd | KeyCode.KeyL,
						secondary: [KeyMod.CtrlCmd | KeyMod.WinCtrl | KeyCode.KeyI]
					}
				},
				menu: [{
	...
	registerAction2(class ShowExtensionsUsingCopilot extends Action2 {
		...
		constructor() {
			super({
				...
				title: localize2('showCopilotUsageExtensions', "Show Extensions using Neo Agents"),
				f1: true,
	...
	registerAction2(class ShowQuotaExceededDialogAction extends Action2 {
		...
		constructor() {
			super({
				...
				title: localize('upgradeChat', "Upgrade Neo Agents Plan")
			});
		}
		...
		override async run(accessor: ServicesAccessor) {
			...
			const upgradeToPro = free ? localize('upgradeToPro', "Upgrade to Neo Agents Pro (your first 30 days are free) for:\n- Unlimited inline suggestions\n- Unlimited chat messages\n- Access to premium models") : undefined;

			await dialogService.prompt({
				type: 'none',
				message: localize('copilotQuotaReached', "Neo Agents Quota Reached"),
				cancelButton: {
				...
				buttons: [
					{
						label: free ? localize('upgradePro', "Upgrade to Neo Agents Pro") : localize('upgradePlan', "Upgrade Neo Agents Plan"),
						run: () => {
