...
Registry.as<IEditorFactoryRegistry>(EditorExtensions.EditorFactory).registerEditorSerializer(NeocodeSwarmSettingsEditorInput.ID, NeocodeSwarmSettingsEditorSerializer);
	...
	constructor() {
		super({
			...
			menu: [
				...
				{
					id: NEOCODE_GLOBAL_SETTINGS_MENU,
					group: '1_neocode',
					order: 1
				},
				{
					id: NEOCODE_SETTINGS_MENU,
					group: '1_neocode',
					order: 1
				},
				{
